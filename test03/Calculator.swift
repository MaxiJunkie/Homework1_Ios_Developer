...
class Calculator {
    ...
    private var operations: [String: OperationType] = [
        ...
        "y√x": OperationType.binary({ pow($0, 1/$1 ) }),
        "e^x": OperationType.unary({pow(M_E, $0 )}),
        "x^2": OperationType.unary({pow($0,2)}),
        "x^3": OperationType.unary({pow($0,3)}),
        "=": OperationType.equal
    ]
